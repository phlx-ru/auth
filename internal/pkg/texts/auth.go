...
const (
	...
	AuthCodeEmailBody    = `<p><b>{{ .code }}</b> — Ваш временный код авторизации, действительный в течение {{ .minutes }}.</p>
</br>
<p>Сообщение сформировано автоматически. Пожалуйста, не отвечайте на него.</p>
<p>Если Вы не запрашивали код, то просто проигнорируйте это письмо.</p>`
...
Никому его не сообщайте!`
	...
	ResetPasswordEmailBody    = `<p><b>{{ .hash }}</b> — Ваш код для сброса пароля.</p>
<p>Используйте его на странице, которая появится позже [// TODO сделать страницу]
или перейдите по ссылке, которая появится позже [// TODO сделать ссылку]</p>
<br/>
<p>Сообщение сформировано автоматически. Пожалуйста, не отвечайте на него.</p>
<p>Если Вы не запрашивали код, то просто проигнорируйте это письмо.</p>`
	// TODO ^
