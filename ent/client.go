...
func (c *CodeClient) UpdateOneID(id int) *CodeUpdateOne {
...
func (c *CodeClient) DeleteOneID(id int) *CodeDeleteOne {
...
func (c *CodeClient) Get(ctx context.Context, id int) (*Code, error) {
	return c.Query().Where(code.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *CodeClient) GetX(ctx context.Context, id int) *Code {
