...
// function as Code mutator.
type CodeFunc func(context.Context, *ent.CodeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CodeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.CodeMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CodeMutation", m)
	}
	return f(ctx, mv)
}
